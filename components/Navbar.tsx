...
const Navbar = () => {
  return (
    <div className='my-10 mx-10 flex flex-row place-items-center gap-[50px]'>
      ...
      <div className="w-[700px] h-[78px] border-[2px] border-[#D9D9D9] rounded-[50px] shadow-lg flex place-items-center justify-center">
        <div className='w-[657px] h-[41px] justify-center place-items-center flex flex-row whitespace-nowrap gap-5'>
          <div className='grid grid-rows-2 gap-[2px] border-r pr-10'>
            ...
            <button className='hover:scale-105 transition-transform duration-100'>
              <p className='text-[14px] font-light text-[#777777]'>Search Properties&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</p>
            </button>
          </div>
          <div className='grid grid-rows-2 gap-[2px] border-r px-10 text-left'>
            ...
            <button className='hover:scale-105 transition-transform duration-100'>
              <p className='text-[14px] font-light text-[#777777]'>Select Date</p>
            </button>
          </div>
      ...
      <button>
  <FaHeart className="text-[24px] text-gray-300 hover:text-gray-500 hover:scale-105 transition-transform duration-150" />
</button>

<button>
  <CgProfile className="text-[24px] text-gray-300 hover:text-gray-500 hover:scale-105 transition-transform duration-150" />
</button>
    </div>
  )
}
